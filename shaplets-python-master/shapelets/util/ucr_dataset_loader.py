...
def load_dataset(dataset_name, dataset_folder):
    train_file_path = os.sep.join(os.path.realpath(__file__).split(os.sep)[:-1]) + '/' + dataset_folder + "/" + dataset_name + "/" + dataset_name + "_TRAIN"
    test_file_path = os.sep.join(os.path.realpath(__file__).split(os.sep)[:-1]) + '/' + dataset_folder + "/" + dataset_name + "/" + dataset_name + "_TEST"
